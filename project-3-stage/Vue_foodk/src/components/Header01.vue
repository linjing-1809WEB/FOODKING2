...
<!-- 搜索框 -->
  <div class="my_header_02">
    ...
    <router-link class="my_suba" to="/pprodut?kwords=" @click="search">GO</router-link>
  </div>
<!-- 下拉选项 -->
  <div id="target" :class="{'d-none':navHide}">
    <ul class="list-group text-center">
      <li class="list-group-item"><router-link class="text-white" to="About?aid=1">关于美味王</router-link></li>
      <li class="list-group-item"><router-link class="text-white" to="News?nid=1">最新消息</router-link></li>
      <li class="list-group-item"><router-link class="text-white" to="/member/Register">会员中心</router-link></li>
      <li class="list-group-item"><router-link class="text-white" to="/plist?fid=13">线上购物</router-link></li>
      <li class="list-group-item"><router-link class="text-white" to="/Join?uid=1">加盟专区</router-link></li>
